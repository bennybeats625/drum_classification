...
#folder_path = r'.\sample_data\total_mini'
...
if load_the_model:
    ...
    # linear layer input comes from imageW x imageH x out_channel / (kernel_size^2)^2
    # example had 28*28*64/(2^2)(2^2) = 3136
    # 
    # I have 217*558*64/(2^2)^2 = 484344
    #
    # This doesn't work bc why?
    # It expects the number 480384
    # 
    # Also I'm just using whatever it says it should be; there seems to be more to the number??
